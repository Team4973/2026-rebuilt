...
# Position 3: rightmost from driver POV (low Y for blue, high Y for red)
# Blue faces 0° (toward red wall), red faces 180° (toward blue wall).
_BLUE_POSE = Pose2d(_STARTING_X_BLUE, 2.0, Rotation2d.fromDegrees(0))
_RED_POSE = Pose2d(_STARTING_X_RED, 6.0, Rotation2d.fromDegrees(180))
...
def position3_auto(container) -> commands2.Command:
    """Starting position 3 (rightmost from driver perspective).
